...
public class SugarZaifBuyer {
	...
	public SugarZaifBuyer(CurrencyPair pair, BigDecimal minimumBuyAmount, BigDecimal baseAmountJPY, BigDecimal baseAmountJPYLow,int roundPrice, int roundAmt, String keyStr, String secKeyStr) throws IOException {
		this.pair = pair;
